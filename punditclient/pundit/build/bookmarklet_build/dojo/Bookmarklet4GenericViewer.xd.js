			...
			if (!_4._hasResource["pundit.BasePanel"]) {
				...
				_4.declare("pundit.BasePanel", pundit.BaseComponent, {
					...
					initBaseHTML: function () {
						...
						c += "  </ul>";
						c += "</div>";
						_4.query("#genv_pundit_container").append(c);
					},
			...
			if (!_4._hasResource["pundit.TooltipAnnotationViewer"]) {
				...
				_4.declare("pundit.TooltipAnnotationViewer", pundit.BaseComponent, {
					...
					zoomOnXpointer: function (xp) {
						...
						_4.query("#genv_pundit_container").append("<div id=\"pundit-zoomed-fragment\"><span class=\"pundit-icon-close\"></span></div>");
						_4.behavior.apply();
						st = {
							position: "absolute",
							left: (left - _49c - 1) + "px",
			...
			if (!_4._hasResource["pundit.GUI"]) {
				...
				_4.declare("pundit.GUI", pundit.BaseComponent, {
					...
					show: function () {
						...
						_4.query("#genv_pundit_container").addClass("pundit-gui-hidden");
						_4.addClass("pundit-aw", "pundit-hidden");
						_4.removeClass("pundit-aw", "startup");
						_4.query("#genv_pundit_container").addClass("pundit-aw-hidden");
					...
					hide: function () {
						...
						_4.query("#genv_pundit_container").removeClass("pundit-gui-hidden pundit-gui-shown");
						_4.removeClass("pundit-aw", "pundit-hidden pundit-shown");
						_4.addClass("pundit-aw", "startup");
						_4.query("#genv_pundit_container").removeClass("pundit-aw-hidden pundit-aw-shown");
					},
					initBehaviors: function () {
						var self = this;
						_PUNDIT.init.onInitDone(function () {
					...
					toggleWindow: function () {
						...
						_4.query("#genv_pundit_container").toggleClass("pundit-gui-hidden");
						_4.query("#genv_pundit_container").toggleClass("pundit-gui-shown");
						self.resizeAnnotationWindow();
					},
					toggleAnnotationWindow: function () {
						var a = _4.query("#pundit-aw"),
								b = _4.query("#genv_pundit_container"),
								self = this;
			...
			if (!_4._hasResource["pundit.LoadingBox"]) {
				...
				_4.declare("pundit.LoadingBox", pundit.BaseComponent, {
					...
					constructor: function () {
						...
						lbw += "</div>";
						_4.query("#genv_pundit_container").append(lbw);//edit Felix: war query("body")
						self.initBehaviors();
					},
					initBehaviors: function () {
						var self = this;
			...
			if (!_4._hasResource["pundit.PageHandler"]) {
				...
				_4.declare("pundit.PageHandler", pundit.BaseComponent, {
					constructor: function (_86f) {
						...
						_4.query("#genv_pundit_container").append(a);//edit Felix : war "body". s.a. andere Ersetzungen
						self.initBehaviors();
					},
					initBehaviors: function () {
						var self = this;
				...
				_4.declare("pundit.ImageFragmentHandler", pundit.BaseComponent, {
					...
					showBaloon: function () {
						...
						if ((self.imgAnn === null) || (typeof (self.imgAnn) === "undefined")) {
							...
							_4.query("#genv_pundit_container").append(self.imgAnn);
						}
					},
