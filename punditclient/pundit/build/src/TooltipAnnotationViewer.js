...
dojo.declare("pundit.TooltipAnnotationViewer", pundit.BaseComponent, {
	...
	extractItemFromAnnContent: function (uri, it) {
		...
		if (typeof(it[uri]) === 'undefined') {
			...
			//Felix: passiert bei annotationen über mittlerweile gelöschten Items
			//debugger;
			console.log('TODO: Error? Literal alone?', it, uri);
			return;
		}
	...
	zoomOnXpointer: function (xp) {
		...
		dojo.query('TooltipAnnotationViewer.js').append('<div id="pundit-zoomed-fragment"><span class="pundit-icon-close"></span></div>');
		dojo.behavior.apply();
