...
dojo.declare("pundit.Configuration", pundit.BaseComponent, {
	...
	defaults: {
		 ...
		 */
		annotationServerBaseURL: 'http://localhost/annotationserver/',//EXTERNAL_SERVER_ADDRESS
		...
		vocabularies: ['http://localhost/viewer/punditclient/pundit/build/examples/vocabs/ibr_church_taxonomy.jsonp'],//EXTERNAL_SERVER_ADDRESS
		/**
		...
		modules: {
			...
			'selectors': {
				/*				'Freebase': {
				 ...
				 'Europeana': {
				 name: 'europeana', label: 'Europeana', active: true
				 },
				 'EuropeanaEDM': {
			...
			'pundit.NotebookManager': {
				...
				askBaseURL: 'http://localhost/ask/', //EXTERNAL_SERVER_ADDRESS
				debug: false//Felix
			},
