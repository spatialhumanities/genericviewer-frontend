...
THCTagCore.Annotate = {
	...
	selectionLinkButton: function (elementName, startUrl, startXPath, startOffset, endXPath, endOffset) {
		...
		imageIcon.setAttribute("onClick", "THCTag.show(\"" + startUrl + "\", \"" + startXPath + "\", " + startOffset + ", \"" + endXPath + "\" , " + endOffset + "); return false;");
...
THCTagUtil = {
	...
	getNotifyMessage: function (xpointer, content) {
		...
		if (xpointer != '') {
			...
			xmlResult += '<container_uri>' + window.location.href + '</container_uri>';
		}
