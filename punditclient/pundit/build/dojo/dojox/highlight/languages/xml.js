...
if (!dojo._hasResource["dojox.highlight.languages.xml"]) {
	...
	(function () {
		...
		dh.languages.xml = {defaultMode: {contains: ["pi", "comment", "cdata", "tag"]}, case_insensitive: true, modes: [
			...
			{className: "tag_internal", begin: "^", endsWithParent: true, contains: ["attribute"], relevance: 0, illegal: "[\\+\\.]"},
			_2,
			_3
		], XML_COMMENT: _1, XML_ATTR: _2, XML_VALUE: _3};
	})();
}
