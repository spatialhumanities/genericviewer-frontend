...
if (!dojo._hasResource["dojox.widget.rotator.PanFade"]) {
	...
	(function (d) {
		...
		function _4(_5, _6) {
			var j = {node: _6.current.node, duration: _6.duration, easing: _6.easing}, k = {node: _6.next.node, duration: _6.duration, easing: _6.easing}, r = _6.rotatorBox, m = _5 % 2, a = m ? "left" : "top", s = (m ? r.w : r.h) * (_5 < 2 ? -1 : 1), p = {}, q = {};
		...
		d.mixin(dojox.widget.rotator, {panFade: function (_8) {
			...
			return _4(_b, _8);
		}, panFadeDown: function (_10) {
			return _4(_1, _10);
		}, panFadeRight: function (_11) {
			return _4(_2, _11);
		}, panFadeUp: function (_12) {
			return _4(UP, _12);
		}, panFadeLeft: function (_13) {
			return _4(_3, _13);
		}});
	})(dojo);
}
