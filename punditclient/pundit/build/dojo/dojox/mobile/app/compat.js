...
if (!dojo._hasResource["dojox.mobile.app.compat"]) {
	...
	dojo.extend(dojox.mobile.app.AlertDialog, {_doTransition: function (dir) {
		...
		var _86 = this.controller.getWindowSize().h;
		var _87 = _86 - h;
		var low = _86;
		var _88 = dojo.fx.slideTo({node: this.domNode, duration: 400, top: {start: dir < 0 ? _87 : low, end: dir < 0 ? low : _87}});
		var _89 = dojo[dir < 0 ? "fadeOut" : "fadeIn"]({node: this.mask, duration: 400});
		var _8a = dojo.fx.combine([_88, _89]);
		var _8b = this;
		dojo.connect(_8a, "onEnd", this, function () {
			if (dir < 0) {
				_8b.domNode.style.display = "none";
				dojo.destroy(_8b.domNode);
				dojo.destroy(_8b.mask);
			}
		});
		_8a.play();
	}});
	dojo.extend(dojox.mobile.app.List, {deleteRow: function () {
		...
		var _8c = dojo.contentBox(row).h;
		dojo.animateProperty({node: row, duration: 800, properties: {height: {start: _8c, end: 1}, paddingTop: {end: 0}, paddingBottom: {end: 0}}, onEnd: this._postDeleteAnim}).play();
	}});
	...
	if (dojox.mobile.app.ImageThumbView) {
		dojo.extend(dojox.mobile.app.ImageThumbView, {place: function (_8d, x, y) {
			dojo.style(_8d, {top: y + "px", left: x + "px", visibility: "visible"});
		}});
	}
}
