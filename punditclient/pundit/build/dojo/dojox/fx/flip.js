...
if (!dojo._hasResource["dojox.fx.flip"]) {
	...
	dojox.fx.flipCube = function (_18) {
		var _19 = [], mb = dojo.marginBox(_18.node), _1a = mb.w / 2, _1b = mb.h / 2, _1c = {top: {pName: "height", args: [
			{whichAnim: "first", dir: "top", shift: -_1b},
			{whichAnim: "last", dir: "bottom", shift: _1b}
		]}, right: {pName: "width", args: [
			{whichAnim: "first", dir: "right", shift: _1a},
			{whichAnim: "last", dir: "left", shift: -_1a}
		]}, bottom: {pName: "height", args: [
			{whichAnim: "first", dir: "bottom", shift: _1b},
			{whichAnim: "last", dir: "top", shift: -_1b}
		]}, left: {pName: "width", args: [
			{whichAnim: "first", dir: "left", shift: -_1a},
			{whichAnim: "last", dir: "right", shift: _1a}
		]}};
