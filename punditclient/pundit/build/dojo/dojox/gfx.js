...
if (!dojo._hasResource["dojox.gfx._base"]) {
	...
	(function () {
		...
		g._removeClass = function (_1e, _1f) {
			...
			if (cls) {
				_1e.setAttribute("className", cls.replace(new RegExp("(^|\\s+)" + _1f + "(\\s+|$)"), "$1$2"));
			}
		};
		b._getFontMeasurements = function () {
			var _20 = {"1em": 0, "1ex": 0, "100%": 0, "12pt": 0, "16px": 0, "xx-small": 0, "x-small": 0, "small": 0, "medium": 0, "large": 0, "x-large": 0, "xx-large": 0};
			if (dojo.isIE) {
		...
		b._getTextBox = function (_25, _26, _27) {
			...
			if (!_23) {
				_23 = dojo.create("div", {style: {position: "absolute", top: "-10000px", left: "0"}}, dojo.body());
			}
			m = _23;
			m.className = "";
			s = m.style;
	...
	dojo.mixin(dojox.gfx, {defaultPath: {type: "path", path: ""}, defaultPolyline: {type: "polyline", points: []}, defaultRect: {type: "rect", x: 0, y: 0, width: 100, height: 100, r: 0}, defaultEllipse: {type: "ellipse", cx: 0, cy: 0, rx: 200, ry: 100}, defaultCircle: {type: "circle", cx: 0, cy: 0, r: 100}, defaultLine: {type: "line", x1: 0, y1: 0, x2: 100, y2: 100}, defaultImage: {type: "image", x: 0, y: 0, width: 0, height: 0, src: ""}, defaultText: {type: "text", x: 0, y: 0, text: "", align: "start", decoration: "none", rotated: false, kerning: true}, defaultTextPath: {type: "textpath", text: "", align: "start", decoration: "none", rotated: false, kerning: true}, defaultStroke: {type: "stroke", color: "black", style: "solid", width: 1, cap: "butt", join: 4}, defaultLinearGradient: {type: "linear", x1: 0, y1: 0, x2: 100, y2: 100, colors: [
		...
		return (_2b instanceof dojo.Color) ? _2b : new dojo.Color(_2b);
		...
		for (var i in _2f) {
			if (!(i in _31)) {
				_31[i] = dojo.clone((i in _30) ? _30[i] : _2f[i]);
			}
		}
		return _31;
		...
		return _34.style + " " + _34.variant + " " + _34.weight + " " + _34.size + " " + _34.family;
		...
		return a && b && a == b;
	}, switchTo: function (_37) {
		var ns = dojox.gfx[_37];
		if (ns) {
			dojo.forEach(["Group", "Rect", "Ellipse", "Circle", "Line", "Polyline", "Image", "Text", "Path", "TextPath", "Surface", "createSurface"], function (_38) {
				dojox.gfx[_38] = ns[_38];
			});
		}
	}});
}
if (!dojo._hasResource["dojox.gfx"]) {
	...
	dojo.loadInit(function () {
		var gfx = dojo.getObject("dojox.gfx", true), sl, _39, _3a;
		while (!gfx.renderer) {
			if (dojo.config.forceGfxRenderer) {
				dojox.gfx.renderer = dojo.config.forceGfxRenderer;
				break;
			}
			var _3b = (typeof dojo.config.gfxRenderer == "string" ? dojo.config.gfxRenderer : "svg,vml,canvas,silverlight").split(",");
