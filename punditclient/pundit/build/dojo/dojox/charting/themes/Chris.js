...
if (!dojo._hasResource["dojox.charting.themes.Chris"]) {
	...
	(function () {
		...
		_1.Chris = new dc.Theme({chart: {fill: "#c1c1c1", stroke: {color: "#666"}}, plotarea: {fill: "#c1c1c1"}, series: {stroke: {width: 2, color: "white"}, outline: null, fontColor: "#333"}, marker: {stroke: {width: 2, color: "white"}, outline: {width: 2, color: "white"}, fontColor: "#333"}, seriesThemes: [
			{fill: g(_3, "#01b717", "#238c01")},
			{fill: g(_3, "#d04918", "#7c0344")},
			{fill: g(_3, "#0005ec", "#002578")},
			{fill: g(_3, "#f9e500", "#786f00")},
			{fill: g(_3, "#e27d00", "#773e00")},
			{fill: g(_3, "#00b5b0", "#005f5d")},
			{fill: g(_3, "#ac00cb", "#590060")}
		], markerThemes: [
			{fill: "#01b717", stroke: {color: "#238c01"}},
			{fill: "#d04918", stroke: {color: "#7c0344"}},
			{fill: "#0005ec", stroke: {color: "#002578"}},
			{fill: "#f9e500", stroke: {color: "#786f00"}},
			{fill: "#e27d00", stroke: {color: "#773e00"}},
			{fill: "#00b5b0", stroke: {color: "#005f5d"}},
			{fill: "#ac00cb", stroke: {color: "#590060"}}
		]});
