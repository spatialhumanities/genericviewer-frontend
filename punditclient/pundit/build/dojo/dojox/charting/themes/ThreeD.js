...
if (!dojo._hasResource["dojox.charting.themes.ThreeD"]) {
	...
	(function () {
		var dc = dojox.charting, _1 = dc.themes, _2 = dc.Theme, gi = _1.gradientGenerator.generateGradientByIntensity, _3 = ["#f00", "#0f0", "#00f", "#ff0", "#0ff", "#f0f"], _4 = {type: "linear", space: "shape", x1: 0, y1: 0, x2: 100, y2: 0}, _5 = [
			{o: 0, i: 174},
			{o: 0.08, i: 231},
			{o: 0.18, i: 237},
			{o: 0.3, i: 231},
			...
			{o: 0.9, i: 102},
			{o: 1, i: 174}
		], _6 = 2, _7 = 100, _8 = 50, _9 = dojo.map(_3, function (c) {
