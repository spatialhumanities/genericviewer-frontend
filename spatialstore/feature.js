...
GV.Spatialstore.Feature = function(xml) {
	...
	var createDOM = function() { // object overview
		...
		switch (geometry.getType()) {
			...
			case "MULTIPOLYGON": geomLabel = "Fläche"; break;
		...
		if (lastModify) {
			...
			dateP1.appendChild(document.createTextNode("Datum"));
		...
		if (creator != "null") {
			...
			creaP1.appendChild(document.createTextNode("Ersteller"));
	...
	this.displayInfo = function() { // info-window below floorplan
		...
		fidA.setAttribute("href",href+".xml");
		fidA.setAttribute("title",href);
		fidA.setAttribute("target","_blank");
		fidA.appendChild(document.createTextNode("URI"));
		fid.appendChild(fidA);
		span.appendChild(fid);
		
		// Semantic Data
		var fidS = document.createElement("div");
		fidS.setAttribute("class","infoFeature");
		var fidSem = document.createElement("a");
		fidSem.setAttribute("class","content");
		fidSem.setAttribute("href",GV.TRIPLESTORE_GUI+"/explore?resource=<"+href+">");
		fidSem.setAttribute("title","Semantic Data");
		fidSem.setAttribute("target","_blank");
		fidSem.appendChild(document.createTextNode("Triples"));
		fidS.appendChild(fidSem);
		span.appendChild(fidS);
