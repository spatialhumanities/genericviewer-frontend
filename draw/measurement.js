﻿GV.Draw.Measurement = function(mode,f) {
	...
	this.getMessage = function() {
		if (!finished)
			return "draw " + type + "<br /><br />Click on panorama for drawing";
		if (finished == "drag")
			return "move anchorpoints<br /><br />drag & drop anchorpoints";
		if (finished == "delete")
			return "remove anchorpoints<br /><br />Click on anchorpoints to remove them";
		if (finished == "add")
			return "add anchorpoints<br /><br />Click on outline to add anchorpoints";
	}
